...
const FAQSMM = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "The cost of hiring a social media marketing company can vary significantly based on the range of services offered, the organization's scale, and the platforms used. Typically, you can expect to spend anywhere from a few hundred to several thousand dollars each month.",
    },
    {
