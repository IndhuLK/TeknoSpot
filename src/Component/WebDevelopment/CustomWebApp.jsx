      ...
      <div className="flex flex-col md:flex-row items-center justify-center px-20 p-6 bg-white gap-10">
        ...
        <div className="w-full md:w-1/2">
          ...
          <h2 className="text-4xl text-gray-800">
            Custom <span className="font-bold text-black">Web Application</span>
          </h2>
          <h3 className="text-4xl font-bold text-black mt-2">Development</h3>
          <p className="text-yellow-500 font-semibold text-md mt-5">Get in touch with us today or send an email, and let's talk more about your project.
</p>
